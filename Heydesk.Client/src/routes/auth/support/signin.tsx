...
import { customerSignInSchema } from "@/lib/validators/auth.validator";

export const Route = createFileRoute("/auth/support/signin")({
        ...
        <Card className="min-w-sm">
          ...
          <CardFooter>
            <p className="text-center text-sm w-full">
              ...
              <Link to="/auth/support/signup" className="underline">
                Sign up
              </Link>
            </p>
          </CardFooter>
