...
// Support: sample tickets and chat threads
...
export const tickets = [
  {
    ...
    preview:
      "I’m getting an invalid credentials error when trying to sign in to the dashboard...",
  ...
  },
  {
    ...
    preview:
      "I noticed two charges on my card for the same billing period. Please advise...",
    updatedAt: "2025-09-08T17:01:00Z",
  ...
  {
    id: "tkt-1003",
    subject: "Feature request: export conversations",
    preview:
      "It would be great to export all chat transcripts for audit and training...",
    updatedAt: "2025-09-06T09:40:00Z",
...
export const chats = [
  {
    id: "cht-2001",
    title: "Issue with onboarding flow",
...
export type ChatThread = (typeof chats)[number];
