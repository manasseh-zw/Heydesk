...
export function TicketColumn({ column, onAddTicket }: TicketColumnProps) {
  return (
    <div className="bg-white/20 dark:bg-neutral-900/20 backdrop-blur-xl rounded-3xl p-0  dark:border-neutral-700/50">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          />
          <h3 className="font-light text-neutral-900 dark:text-neutral-100">
            {column.title}
          </h3>
